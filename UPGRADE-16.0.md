...
- method `Shopsys\FrameworkBundle\Model\Stock\StockSettingsDataFacade::edit()` changed its interface:
    ...
    ```
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/65f3846) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/b8583a84a57a6937c3913959fda5e97384602122) to update your project
...
- `Shopsys\FrontendApiBundle\Model\Transport\TransportValidationFacade` class was changed:
    - `checkTransportPrice()` method was renamed to `checkTransportPriceAndWeightLimit()`
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/89cb7ac500fa5a39f70fb84d68505ec895ee97a9) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/xxx) to update your project
...
- method `Shopsys\FrameworkBundle\Model\Slider\SliderItemFacade::__construct` changed its interface:
    ...
    ```
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/0ce0dc5) to update your project
...
- [features moved](#movement-of-features-from-project-base-to-packages) from project-base to the frontend-api package:
    ...
    - `RegisterMutation`
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/3d6f84a) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/b5dfde43ccc6b16e89231fd29c6bae79d2ed5e84) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/3005a6338e22d6f75927d6c445ef35fee6e931a3) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/826096134728f6900617859b6a2fdf92cbfbfd94) to update your project

#### upgrade doctrine/persistence to ^3.3.3 ([#3498](https://github.com/shopsys/shopsys/pull/3498))

- see [project-base diff](https://www.github.com/shopsys/project-base/commit/a26a04f) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/8ae98f5) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/2bb512118d7fee55dfcb41dcb88b2fca1971a690) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/2bb5121) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/70c815e047d6e5192b6c6045fd310d1f330004d7) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/1287bbe) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/cccd1f28fce8d642222042d4d0736ba5540373f2) to update your project
...
- see [project-base diff](https://www.github.com/shopsys/project-base/commit/1c847f120293d73102bac5faddecf0768b191e77) to update your project
