            ...
            <label
                ...
                className={twMergeCustom(
                    ...
                    (inputType === 'text-input' || inputType === 'selectbox' || inputType === 'textarea') &&
                        'text-inputPlaceholder peer-hover:text-inputPlaceholderHovered peer-focus:text-inputPlaceholderActive peer-disabled:text-inputPlaceholderDisabled absolute left-3 z-[2] block transition-all',
                    (inputType === 'text-input' || inputType === 'selectbox' || inputType === 'textarea') &&
