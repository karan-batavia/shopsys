...
export const UserNavigation: FC = () => {
    ...
    return (
        <div className="xs:min-w-[300px] flex h-fit min-w-64 flex-col overflow-hidden rounded-xl">
            <button
                className={twJoin(
                    'bg-backgroundMore flex items-center gap-4 px-6 py-3 no-underline last:border-none lg:hidden',
            ...
            >
                ...
                <Button
                    ...
                    className={twJoin(
                        getMenuItemTwClass(),
                        'font-primary !text-text hover:text-textAccent justify-start bg-transparent !px-4 text-sm leading-5 font-normal !outline-hidden hover:bg-transparent hover:underline',
                    )}
